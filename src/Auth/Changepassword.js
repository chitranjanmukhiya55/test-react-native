...
class Changepassword extends Component {
  ...
  componentDidMount() {
    this.getUserDetails();
    consolepro.consolelog("iam change password2626");
  }
  ...
  submit_btn = () => {
    if (config.app_status == 0) {
      ...
      if (letters_pas.test(oldpassword) !== true) {
        msgProvider.toast(msgText.wrongpaass[config.language], "center");
        return false;
      }
      //======================================= newpassword===================
      ...
      if (letters_pas1.test(newpassword) !== true) {
        msgProvider.toast(msgText.passwordValidnew[config.language], "center");
        return false;
      }
      //================================confirmpassword===================
