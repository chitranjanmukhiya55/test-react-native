...
class Notification extends Component {
      ...
      notification_arr: [
        {
          ...
          details: "Andrew John accepted your request",
          img: localimag.min13_img,
        },
        {
          name: "James William",
          date: "20-Nov-22, 01:00 PM",
          message: "Creamson Caterers",

          details: "James William rejected your request",
          find: "Find New Vendor",
          img: localimag.img18_img,
        },
        {
          name: "Daniel Michael",
          date: "20-Nov-22, 12:00 PM",
          message: "DJ Ocean",
          // cancle: localimag.cancle_icon,
          details: "Daniel Michael accepted your request",
          img: localimag.min13_img,
        },
        {
          name: "You",
          date: "20-Nov-22, 11:00 AM",
          message: "",

          details: "You have sucessfully send request to vendors ",
          img: localimag.img25_img,
        },
        {
          name: "Andrew John",
          date: "20-Nov-22, 02:00 PM",
  ...
  onClick = (action, action_id) => {
    ...
    if (
      action == "add_subscription_order" ||
      action == "cancel_subscription_order" ||
      action == "add_subscription" ||
      action == "update_subscription_order" ||
      action == "edit_subscription_notification" ||
      ...
      if (action == "buy_subscription" || action == "cancel_subscription") {
        ...
        if (
          action == "cancel_one_time_purchase_order" ||
          action == "add_one_time_purchase_order" ||
          action == "update_one_time_purchase_order" ||
          action == "normal_order"
        ) {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          <View style={{ width: (mobileW * 50) / 100, alignSelf: "center" }}>
            <Text
              style={{
        ...
        >
          {config.app_status == 1 ? (
            <>
              {this.state.notification_arr != "NA" &&
                this.state.notification_arr != "NAA" && (
                  <View style={{ paddingBottom: (mobileH * 10) / 100 }}>
                    <FlatList
                      ...
                      renderItem={({ item, index }) => (
                        <TouchableOpacity
                          onPress={() =>
                            this.onClick(item.action, item.action_id)
                          }
                          activeOpacity={0.7}
                        >
                          <View
                            ...
                            >
                              <Text
                                style={{
                                  ...
                                  fontFamily: Font.FontRegular,
                                  width: (mobileW * 64) / 100,
                                  textDecorationColor: Colors.bluegreen_color,
                  ...
                  >
                    ...
                    >
                      ...
                      <View>
                        ...
                        >
                          Your parcel will be arrived on 04/10/21
                        </Text>
                      </View>
                    </View>
