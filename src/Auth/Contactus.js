...
class Contactus extends Component {
  ...
  componentDidMount() {
    consolepro.consolelog("I am on student contact us  page1919");
  ...
  submitBtn = () => {
    ...
    if (config.app_status == 0) {
      ...
      let { user_id, fullname, email, message } = this.state;
      consolepro.consolelog({ user_id, fullname, email, message });
      ...
      let url = config.baseURL + "new_contact_us.php";
          ...
          >
            <View style={styles.innerContainer}>
              ...
              <TextInput
                ...
                onChangeText={(txt) => {
                  this.setState({ textLength: txt.length, message: txt });
                }}
