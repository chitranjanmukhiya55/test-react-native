...
export default class ProposedEventVendorList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      Tab: 0,
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={{ alignItems: "center", alignSelf: "center" }}>
          ...
          >
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate("MyEventsOngoing")}
              activeOpacity={0.7}
        ...
        >
          ...
          {/* //=========Continue Submit============// */}
          <TouchableOpacity
            onPress={() => this.props.navigation.navigate("SuccessfullySent")}
            activeOpacity={0.7}
            style={{
              alignItems: "center",
              alignSelf: "center",
