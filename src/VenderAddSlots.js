...
export default class VenderAddSlots extends Component {
  constructor(props) {
    super(props);
    this.state = {
      celander: 0,
  ...
  async getDatesBetween() {
    ...
    let url = config.baseURL + "add_new_availability.php";
        ...
        <View style={{ alignItems: "center", alignSelf: "center" }}>
          ...
          >
            ...
            <View style={{ width: (mobileW * 70) / 100, alignItems: "center" }}>
              ...
              >
                {Lang_chg.Add_Avelability_txt[config.language]}
              </Text>
            </View>
            <View
            ...
            <>
              ...
              {this.state.allTimeSlots.length > 0 && (
                <FlatList
                  ...
                  contentContainerStyle={{ marginBottom: (mobileH * 3) / 100 }}
