...
class VendorCreatePassword extends Component {
  ...
  constructor(props) {
    ...
    consolepro.consolelog('user_iduser_id', this.state.user_id);
  }
  ...
  onSubmit = () => {
    ...
    if (config.app_status == 0) {
      ...
      if (letters_pas.test(newpassword) !== true) {
      ...
      let url = config.baseURL + 'reset_password_new.php';
      var data = new FormData();
      data.append('user_id', user_id);
      data.append('new_pasword', newpassword);
...
export default VendorCreatePassword;
