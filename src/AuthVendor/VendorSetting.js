      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          >
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate("VendorEditAboutUs")
              }
              activeOpacity={0.7}
          ...
          >
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate("VendorEditAvailaibility")
              }
              activeOpacity={0.7}
              style={styles.setting_view}
            >
          ...
          >
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate("VendorEditServices")
              }
              activeOpacity={0.7}
              style={styles.setting_view}
            >
          ...
          >
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate("VendorEditWorkPhotos")
              }
              activeOpacity={0.7}
              style={styles.setting_view}
            >
