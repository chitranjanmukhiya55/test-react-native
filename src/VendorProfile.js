...
export default class VendorProfile extends Component {
  ...
  componentDidMount() {
    ...
    this.focusListener = navigation.addListener("focus", () => {
      consolepro.consolelog("page6666");
  ...
  getVenderProfile = async () => {
    ...
    let url =
      config.baseURL + "get_profile_vendor.php?user_id=" + user_details.user_id;
            ...
            >
              ...
              >
                <Image
                  ...
                  source={localimag.settings_vendor}
                ></Image>
              </TouchableOpacity>
            </View>
          </LinearGradient>
                  ...
                  source={
                    this.state.vendorAllDetails.user_image != null
                      ? {
                          uri:
                            config.img_url +
                            this.state.vendorAllDetails.user_image,
                        }
