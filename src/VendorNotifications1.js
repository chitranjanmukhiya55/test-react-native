...
class VendorNotifications1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      user_id: "",
                ...
                <View>
                  <TouchableOpacity
                    onPress={() => {
                      ...
                      if (item.action == "request" || item.action == "rating") {
                        this.props.navigation.navigate("VendorBirthdayHome", {
                          item: item.action_id,
                        });
                      }
                    }}
...
export default VendorNotifications1;
