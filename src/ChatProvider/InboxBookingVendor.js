...
class InboxBookingVendor extends Component {
  constructor(props) {
    super(props);
    this.state = {
      user_id: 1,
  ...
  checkfreindstatus = async (item) => {
    this.props.navigation.navigate("ChatBooking", {
      chatdata: {
        ...
        image: config.img_url + item.images,
        blockstatus: "no",
      },
    });
  };
              ...
              <Image
                ...
                source={
                  item.images != undefined
                    ? { uri: config.img_url + item.images }
...
export default InboxBookingVendor;
