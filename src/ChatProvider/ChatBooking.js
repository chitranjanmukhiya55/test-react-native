...
export default class Chat extends Component {
  ...
  OpenDoc = name => {
    ...
    if (name != null) {
      ...
      Linking.openURL(docurl).catch(err => alert('Please contact to admin'));
    }
  };
  getmessagedata = async () => {
    var userdata = await localStorage.getItemObject('user_arr');
    consolepro.consolelog('getmessagedata');
    this.setState({user_id: userdata.user_id, userDetails: userdata});
  ...
  sendmessagecallbtn = async (messageType, message) => {
    ...
    var messageIdME =
      'u_' + user_id + '__u_' + other_user_id + '_b_' + booking_id;
    var messageIdOther =
      'u_' + other_user_id + '__u_' + user_id + '_b_' + booking_id;
  ...
  Camerapopen = async () => {
    mediaprovider
      ...
      .then(res => {
        ...
        setTimeout(() => {
          this.btnOpneImageOption(res.path);
        }, 500);
      })
      .catch(error => {
      ...
      <TouchableOpacity
        ...
        <SafeAreaView style={styles.container}>
          ...
          <Modal
            ...
            <SafeAreaView style={{backgroundColor: '#00000080', flex: 1}}>
              <StatusBar
                hidden={false}
                translucent={false}
                backgroundColor={Colors.whiteColor}
          ...
          <View style={{flex: 1, backgroundColor: Colors.white_color}}>
            <View style={{alignItems: 'center', alignSelf: 'center'}}>
              <LinearGradient
                ...
                <View
                  style={{flexDirection: 'row', width: (mobileW * 70) / 100}}>
                  <Image
                    onError={() => {
                      var data = this.state.data;
                      data.image = null;
                  ...
                  <View
                    ...
                    <View style={{flexDirection: 'row'}}>
                      <Text
                        ...
                        {'Booking ID : ' + this.state.data.booking_number + ' '}
                      </Text>
                  ...
                  <TouchableOpacity
                    ...
                    <View
                      ...
                      <TextInput
                        ...
                        placeholder={
                          Lang_chg.type_something_txt[config.language]
                        }
                        onFocus={() => {
